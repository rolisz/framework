...
Trigger an HTTP 404 error \hypertarget{classrolisz_a78ab5fc58d307458ac8767f50178fc7a}{
\index{rolisz@{rolisz}!matches@{matches}}
\index{matches@{matches}!rolisz@{rolisz}}
\subsubsection[{matches}]{\setlength{\rightskip}{0pt plus 5cm}static matches (
\begin{DoxyParamCaption}
\item[{\$}]{route}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
\label{classrolisz_a78ab5fc58d307458ac8767f50178fc7a}
Checks if \$route matches the current URL 
\begin{DoxyParams}[1]{Parameters}
string & {\em \$route} & \$return TRUE$|$FALSE \\
\hline
\end{DoxyParams}
\hypertarget{classrolisz_ad1b6efe27562cb6620a179f5688417bb}{
...
array 
\end{DoxyReturn}
\hypertarget{classrolisz_aafd29366ef6399da1dd079fc131d8858}{
