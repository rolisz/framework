...
Magic function for serialization \hypertarget{classtable_aa86daa58bc1ff877f2137c27b222dff6}{
...
\end{DoxyParams}
\begin{Desc}
\item[\hyperlink{todo__todo000005}{Todo}]find a way to reduce arguments\end{Desc}
...
\end{DoxyParams}
\begin{Desc}
\item[\hyperlink{todo__todo000006}{Todo}]find a way to reduce arguments 

find a way to add relations between tables with other params \end{Desc}
...
\end{DoxyParams}
\begin{Desc}
\item[\hyperlink{todo__todo000007}{Todo}]find a way to add relationships between tables with other params \end{Desc}
...
Analyzes the relation between tables and marks them accordingly. So far only ONE TO MANY and MANY TO MANY ones. Haven't seen a case of single \hypertarget{classtable_a13bdffdd926f26b825ea57066334ff01}{
...
Populates the \$data property of the object with the columns of the table and gets the primary key of the table, if it exists \hypertarget{classtable_acd2fc9d3975a06de8837cbb9086eebd3}{
...
Save changes made to object. If the object was hydrated, it will be updated. If it was created from scratch, it will be inserted into the database \hypertarget{classtable_a6c52ede0b29dff2c2aaf5a9f7c220de0}{
...
Static wrapper functions Initializes a certain table 
\begin{DoxyParams}[1]{Parameters}
string & {\em \$table} & \\
\hline
int & {\em \$id} & \\
