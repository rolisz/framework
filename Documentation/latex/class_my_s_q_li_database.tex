...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000003}{Todo}]some checks for valid column names and parameters\end{Desc}
...
Creates a table. 
\begin{DoxyParams}[1]{Parameters}
string & {\em \$name} & Has to match this regex \mbox{[}A-\/Za-\/z\mbox{]}\mbox{[}A-\/Za-\/z0-\/9\_\-\mbox{]}$\ast$ \\
\hline
...
\end{DoxyReturn}
\begin{Desc}
\item[\hyperlink{todo__todo000002}{Todo}]change return values for insert, update, delete, select \end{Desc}
